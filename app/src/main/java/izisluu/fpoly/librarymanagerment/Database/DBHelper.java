...
//    public static final String COLLUMN_TENLOAI = "TenLoai";
    ...
    public static final String COLLUMN_NGAYTRA = "NgayTra";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql4 = "CREATE TABLE " + TABLE_PHIEUMUON_NAME + "("
                ...
                + COLLUMN_NGAYTRA + " TEXT NOT NULL,"
                + COLLUMN_TRANGTHAI + " INTEGER NOT NULL,"
                + COLLUMN_THANHTIEN + " TEXT NOT NULL,"
                + COLLUMN_MATHUTHU1 + " TEXT REFERENCES " + TABLE_THUTHU_NAME + "(" + COLLUMN_MATHUTHU + "),"
                ...
                + ")";
        db.execSQL(sql4);
        String insert5 = "INSERT INTO " + TABLE_PHIEUMUON_NAME + " VALUES('pm01','08/06/2023','08/07/2023',1,'100000','luuhpp56774','tv01','s01')";
        db.execSQL(insert5);
